    ...
    public function acceptSkripsi($idSkripsi, $sta)
    {
        ...
        if ($sta === 'true') {
            ...
            for ($i = 1; $i < 3; $i++) {
                ...
                $Catatan = 'Anda Di Tetapkan Sebagai Dosen Pembimbing ' . $nama . ' Anda sekarang bisa mengacc proposal maupun tesis ' . $nama . 'dan juga menambah kartu bimbingan untuk mahasiswa tersebut Anda ditetapkan sebagai pembimbing ke ' . $i;
