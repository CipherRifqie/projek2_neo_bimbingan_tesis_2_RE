				...
				<div class="row">
					<div class="col-md">
						<div class="nav nav-pills mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							...
							<?php if (!$skripsi) { ?>
								<a class="nav-item nav-link <?= $_SESSION['Status'] == 'Skripsi' ? '' : 'disabled'?>" id="navIdeskripsi" data-toggle="tab" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"> <i class="fas fa-file-alt fa-sm" ></i> Ide Tesis 
								</a>
							<?php } else { 
								?>
								<a class="nav-item nav-link" id="navSkripsi" data-toggle="tab" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false" ><i class="fas fa-pencil-alt"></i> Tesis </a>
							<?php } ?>
						</div>
					</div>
